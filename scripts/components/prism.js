System.register(['angular2/core'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            PrismComponent = (function () {
                function PrismComponent() {
                }
                PrismComponent.prototype.ngOnInit = function () {
                    this.language = "language-" + this.language;
                };
                PrismComponent.prototype.ngAfterViewInit = function () {
                    Prism.highlightAll();
                };
                PrismComponent.prototype.ngOnChange = function () {
                    this.language = "language-" + this.language;
                    Prism.highlightAll();
                };
                __decorate([
                ...
                PrismComponent = __decorate([
                    core_1.Component({
                        selector: 'prism',
                        template: "\n        <pre><code [class]=\"language\"><ng-content></ng-content></code></pre>\n    "
                    }), 
